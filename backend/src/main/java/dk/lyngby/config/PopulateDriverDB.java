...
public class PopulateDriverDB {
    ...
    private static List<Driver> getDrivers() {
        Driver driver1 = new Driver("name", "test", "test", "test", null, null);
        Driver driver2 = new Driver("name2", "test2", "test2", "test2", null, null);
        Driver driver3 = new Driver("name3", "test3", "test3", "test3", null, null);
