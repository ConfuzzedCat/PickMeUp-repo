      ...
      <div class="p-4 space-y-2 md:space-y-4 sm:p-6">
        ...
        >
          <div>
            <label
              htmlFor="email"
              class="block mb-1 text-sm font-medium text-white dark:text-white"
            >
              Email
            </label>
            <input
              ...
              id="email"
              ref={email}
              class="bg-gray-600 border border-gray-500 text-white sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div>
            ...
            <input
              ...
              ref={password}
              placeholder="••••••••"
              class="bg-gray-600 border border-gray-500 text-white sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              required=""
            ></input>
          </div>
          <div>
          ...
          <div>
            <label htmlFor="licenseImage" className="block mb-2 text-sm font-medium text-white dark:text-white">
            ...
            <input
                ...
                className="bg-gray-600 border border-gray-500 text-white text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                required=""
            />
          </div>
          <div>
